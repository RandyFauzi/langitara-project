...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('assets/templates/melayu-heritage/css/style.css') }}">
        ...
        <section class="section section-right" id="main-scroll">
            ...
            <article id="cover-section"
                ...
                <video class="video-background" autoplay muted loop playsinline poster="{{ $coverImage }}"
                    style="z-index: 0;">
                    <source src="{{ asset('assets/templates/melayu-heritage/video-melayu.mp4') }}" type="video/mp4">
                </video>
                <!-- Overlay -->
                <div
            ...
            <article id="opening-video"
                ...
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Motif-Bawah.png"
                    ...
                    alt="ornament">
                <!-- Dayak Icon -->
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Icon.png"
            ...
            <article
                ...
                <!-- Bg Patterns -->
                <div
                    style="position: absolute; top: 0; left: 0; width: 100%; height: 80px; background: url('https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Motif-Atas.png') center top/contain no-repeat; opacity: 0.3;">
                </div>
                ...
                <div style="position: relative; z-index: 10; border: 4px solid var(--primary); border-radius: 100px; padding: 48px 16px; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); background: rgba(255,255,255,0.5); backdrop-filter: blur(4px);"
                    ...
                    <div style="margin-top: 48px; margin-bottom: 32px; position: relative;" data-aos="fade-up">
                        <div style="width: 160px; height: 160px; margin: 0 auto 16px; position: relative;">
                            <!-- Left Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Couple-Belakang-2.png"
                                class="ornament-left"
                            ...
                            <!-- Right Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Couple-Depan-2.png"
                    ...
                    <div style="margin-bottom: 32px; position: relative;" data-aos="fade-up">
                        <div style="width: 160px; height: 160px; margin: 0 auto 16px; position: relative;">
                            <!-- Left Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Couple-Depan-1.png"
                                class="ornament-left"
                            ...
                            <img src="{{ $couple->groom_photo ?? 'https://bitwave.my.id/wp-content/uploads/2024/12/Heritage-cpp.jpeg' }}"
                                style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%; border: 3px solid var(--primary); position: relative; z-index: 10; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            <!-- Right Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Couple-Belakang-1.png"
                                class="ornament-right"
            ...
            <div class="ornament-divider"
                ...
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Melayu-Icon.png" alt="divider">
            </div>
