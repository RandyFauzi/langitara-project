<section id="cover"
    ...
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&q=80&w=2000"
    ...
    <div class="relative z-10 px-6 py-12 flex flex-col items-center justify-center h-full fade-in-up">
        <p class="uppercase tracking-[0.2em] text-sm mb-4 text-slate-600">The Wedding Of</p>
