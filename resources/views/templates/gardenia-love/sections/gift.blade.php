    ...
    <div
        ...
        <div class="flex items-center justify-center gap-2 mb-4">
            <span id="account-number" class="text-2xl font-mono text-slate-800 tracking-wide font-bold">
                {{ $gift_account_number ?? '0000 0000 0000' }}
            </span>
            <button onclick="copyToClipboard('{{ $gift_account_number }}')"
        ...
        <p class="font-bold text-slate-800 text-lg">{{ $gift_account_holder ?? 'Couple Name' }}</p>
