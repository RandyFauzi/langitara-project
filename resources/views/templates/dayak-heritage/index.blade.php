...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Alex+Brush&family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=Pinyon+Script&family=Poppins:wght@100;200;300;400;500;600;700&display=swap"
        rel="stylesheet">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('assets/templates/dayak-heritage/css/style.css') }}">
...
<body class="overflow-hidden"> <!-- Initially hidden for cover -->
        ...
        <section class="section section-right" id="main-scroll">
            ...
            <article id="cover-section"
                ...
                <video class="video-background" autoplay muted loop playsinline poster="{{ $coverImage }}"
                    style="z-index: 0;">
                    <source src="{{ asset('assets/templates/dayak-heritage/video-dayak.mp4') }}" type="video/mp4">
                </video>
                <!-- Overlay -->
                <div
            ...
            <article id="opening-video"
                ...
                <!-- Ornament Top -->
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Atas.png"
                    style="position: absolute; top: 0; left: 0; width: 100%; z-index: 3; opacity: 0.6;" alt="ornament">
                <!-- Ornament Bottom -->
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Bawah.png"
                    style="position: absolute; bottom: 0; left: 0; width: 100%; z-index: 3; opacity: 0.6;"
                    alt="ornament">
                <!-- Dayak Icon -->
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Icon.png"
                    style="position: absolute; top: 40px; left: 50%; transform: translateX(-50%); width: 64px; z-index: 4; opacity: 0.5;"
                    alt="icon">
            ...
            <article
                ...
                <!-- Background Ornament -->
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Atas.png"
                    style="position: absolute; top: 0; left: 0; width: 100%; opacity: 0.15;" alt="">
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Bawah.png"
                    style="position: absolute; bottom: 0; left: 0; width: 100%; opacity: 0.15;" alt="">
                ...
                <div style="position: relative; z-index: 10;" data-aos="fade-up">
                    ...
                    <div
                        ...
                        <div style="position: relative; z-index: 10;">
                            <!-- Dayak Icon -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Icon.png"
                                style="width: 56px; margin: 0 auto 16px; opacity: 0.7;" alt="icon">
            ...
            <article
                ...
                <!-- Bg Patterns -->
                <div
                    style="position: absolute; top: 0; left: 0; width: 100%; height: 80px; background: url('https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Atas.png') center top/contain no-repeat; opacity: 0.3;">
                </div>
                ...
                <div style="position: relative; z-index: 10; border: 4px solid var(--primary); border-radius: 100px; padding: 48px 16px; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); background: rgba(255,255,255,0.5); backdrop-filter: blur(4px);"
                    data-aos="zoom-in-up">
                    <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Icon.png"
                        style="width: 96px; margin: 0 auto 24px;">
                    ...
                    <div style="margin-top: 48px; margin-bottom: 32px; position: relative;" data-aos="fade-up">
                        <div style="width: 160px; height: 160px; margin: 0 auto 16px; position: relative;">
                            <!-- Left Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Couple-Belakang-2.png"
                                class="ornament-left"
                                style="position: absolute; top: 50%; left: -80px; width: 100px; max-width: none; opacity: 0.7; transform-origin: center;">
                            <!-- Photo -->
                            <img src="{{ $couple->bride_photo ?? 'https://bitwave.my.id/wp-content/uploads/2024/12/Heritage-cpw.jpeg' }}"
                                style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%; border: 3px solid var(--primary); position: relative; z-index: 10; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            <!-- Right Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Couple-Depan-2.png"
                                class="ornament-right"
                                style="position: absolute; top: 50%; right: -80px; width: 100px; z-index: 5; opacity: 0.7; transform-origin: center;">
                        </div>
                    ...
                    <div style="margin-bottom: 32px; position: relative;" data-aos="fade-up">
                        <div style="width: 160px; height: 160px; margin: 0 auto 16px; position: relative;">
                            <!-- Left Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Couple-Depan-1.png"
                                class="ornament-left"
                                style="position: absolute; top: 50%; left: -80px; width: 100px; z-index: 5; opacity: 0.7; transform-origin: center;">
                            <!-- Photo -->
                            <img src="{{ $couple->groom_photo ?? 'https://bitwave.my.id/wp-content/uploads/2024/12/Heritage-cpp.jpeg' }}"
                                style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%; border: 3px solid var(--primary); position: relative; z-index: 10; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            <!-- Right Ornament -->
                            <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Couple-Belakang-1.png"
                                class="ornament-right"
                                style="position: absolute; top: 50%; right: -80px; width: 100px; max-width: none; opacity: 0.7; transform-origin: center;">
                        </div>
                        <h3 class="font-pinyon" style="font-size: 36px; color: var(--primary);">
                            {{ $couple->groom_nickname ?? 'Syahril' }}
                        </h3>
            ...
            @if(!empty($loveStories) && count($loveStories) > 0)
                <article style="padding: 64px 24px 80px; background: #f6f6f0; position: relative;" data-aos="fade-up">
                    <div style="text-align: center; margin-bottom: 40px;">
                        ...
                        <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Icon.png"
                            style="width: 64px; margin: 0 auto; opacity: 0.5;">
                    </div>
            ...
            <div class="ornament-divider"
                style="background: linear-gradient(to bottom, rgba(0,0,0,0.8), #FFFCF3); padding: 40px 24px;">
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Icon.png" alt="divider">
            </div>
            ...
            <article
                ...
                <!-- Ornaments -->
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Atas.png"
                    style="position: absolute; top: 0; left: 0; width: 100%; opacity: 0.2;">
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Bawah.png"
                    style="position: absolute; bottom: 0; left: 0; width: 100%; opacity: 0.2;">

                <div style="text-align: center; margin-bottom: 40px; position: relative; z-index: 10;"
                    data-aos="fade-down">
                    <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Icon.png"
                        style="width: 80px; margin: 0 auto 16px; opacity: 0.8;">
            ...
            <article
                ...
                <img src="https://bitwave.my.id/wp-content/uploads/2025/03/Dayak-Motif-Atas.png"
                    style="position: absolute; top: 0; left: 0; width: 100%; opacity: 0.1;">
    ...
    @if($invitation->music)
        ...
        <!-- Custom Music Embed (Hidden by default) -->
